      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-grow">
          {!isEditing ? <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            </div> : <div className="space-y-4 bg-planet-dark/40 border border-planet-cyan/20 p-4 rounded-md mb-4">
              <PlanetInput label="Name" name="name" value={editData.name} onChange={handleChange} required />
              <PlanetInput label="Email" name="email" type="email" value={editData.email} onChange={handleChange} required />
              <PlanetInput label="Major" name="major" value={editData.major} onChange={handleChange} required />
            </div>}
              ...
              <div className="mb-3">
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <div className="flex items-center">
                    ...
                    <input type="number" className="ml-2 w-14 bg-planet-dark/50 border border-planet-cyan/30 rounded text-xs p-1 text-white" value={goals.weeklyStudyHoursTarget} onChange={e => updateGoal(e, 'weeklyStudyHoursTarget')} min="1" />
                  </div>
                </div>
                <div className="h-2 bg-planet-dark rounded-full">
                  <div className="h-2 bg-planet-cyan rounded-full" style={{
                  width: `${goals.weeklyStudyHours / goals.weeklyStudyHoursTarget * 100}%`
                }}></div>
                </div>
              </div>
              ...
              <div className="mb-3">
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <div className="flex items-center">
                    ...
                    <input type="number" className="ml-2 w-14 bg-planet-dark/50 border border-planet-cyan/30 rounded text-xs p-1 text-white" value={goals.assignmentCompletion} onChange={e => updateGoal(e, 'assignmentCompletion')} min="0" max="100" />
                  </div>
                </div>
                <div className="h-2 bg-planet-dark rounded-full">
                  <div className="h-2 bg-planet-cyan rounded-full" style={{
                  width: `${goals.assignmentCompletion}%`
                }}></div>
                </div>
              </div>
            </div>
